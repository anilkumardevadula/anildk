...
const EditTaskPopup = ({modal, toggle, updateTask, taskObj}) => {
    ...
    }, [taskObj.Description, taskObj.Email, taskObj.Name, taskObj.Projectname, taskObj.Status, taskObj.enddate, taskObj.mobilenumber, taskObj.startdate])
        ...
        <Modal isOpen={modal} toggle={toggle}>
            ...
            <ModalBody>
                    ...
                    <div className="form-check form-check-inline">
                        ...
                        <label className="form-check-label" htmlFor="progress" >In Progress</label>
                    </div>
                    <div className="form-check form-check-inline">
